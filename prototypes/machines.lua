...
--Humidity settings for the existing machines, negative removes humidity, positive adds humidity
local HUMIDITY_WATER_CONDENSER = -0.5 -- the limit when the water condenser stops producing more water because chunk humidity is too low can be tuned in loop.lua
local HUMIDITY_DEW_COLLECTOR = -0.5
local HUMIDITY_SAND_REFINERY = 0.25
--Watch out as humidity is already generated at night via lightning, generation rate for that can be tuned in pollution.lua
 ...
 -- DEW COLLECTOR PROTOTYPE -------------------------------------------------------------------------------------------------
{
  ...
  energy_source =
  {
    type = "electric",
    usage_priority = "secondary-input",
    emissions_per_minute = { humidity = HUMIDITY_DEW_COLLECTOR }
  },
  energy_usage = "210kW",
  crafting_categories = {"water-condensing"},
...
-- SAND REFINERY PROTOTYPE -------------------------------------------------------------------------------------------------
{
    ...
    energy_source =
    {
      type = "electric",
      usage_priority = "secondary-input",
      emissions_per_minute = { humidity = HUMIDITY_SAND_REFINERY }
    },
    energy_usage = "2500kW",
  ...
  
  {
    ...
    flags = {"placeable-neutral","player-creation"},
    minable = {mining_time = 0.2, result = "basic-sand-refinery"},
    max_health = 350,
    corpse = "foundry-remnants",
    dying_explosion = "foundry-explosion",
    circuit_wire_max_distance = assembling_machine_circuit_wire_max_distance,
    ...
    allowed_effects = {"consumption", "speed", "productivity", "pollution", "quality"},
    crafting_categories = {"basic-sand-treatment"},
    crafting_speed = 1,
    energy_source =
    {
      type = "electric",
    ...
    graphics_set = require("__arrakis_my_dune__.prototypes.entities.basic-sand-refinery-pictures").graphics_set,
    open_sound = sounds.steam_open,
    close_sound = sounds.steam_close,
    working_sound =
    {
...

  {
    ...
    flags = {"placeable-neutral","player-creation"},
    minable = {mining_time = 0.2, result = "sand-collector"},
    max_health = 350,
    corpse = "foundry-remnants",
    dying_explosion = "foundry-explosion",
    circuit_wire_max_distance = assembling_machine_circuit_wire_max_distance,
    ...
    allowed_effects = {"consumption", "speed", "productivity", "pollution", "quality"},
    crafting_categories = {"sand-collector"},
    crafting_speed = 1,
    energy_source =
    {
      type = "electric",
